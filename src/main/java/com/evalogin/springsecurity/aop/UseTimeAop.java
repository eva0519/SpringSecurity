package com.evalogin.springsecurity.aop;

import com.evalogin.springsecurity.entity.ApiUseTime;
import com.evalogin.springsecurity.entity.User;
import com.evalogin.springsecurity.repository.ApiUseTimeRepository;
...
public class UseTimeAop {
    ...
    // Point Cut Around Expression language 부분 유의해서 작성. 여기서 point cut 범위를 클레스 Path로 설정한다
    @Around("execution(public * com.evalogin.springsecurity.controller..*(..))")
